        ...
        <div class="rounded-xl border border-border bg-card p-8 shadow-lg">
          <div class="text-center mb-8">
            <div class="w-16 h-16 mx-auto rounded-2xl bg-primary flex items-center justify-center mb-4">
              <span class="material-icons text-primary-foreground text-4xl">church</span>
            </div>
            <h1 class="text-2xl font-bold text-foreground">ChurchTime</h1>
            <p class="text-muted-foreground mt-1">Faça login para continuar</p>
          </div>
          ...
          <div class="mt-6 text-center space-y-3">
            <a routerLink="/forgot-password" class="text-sm text-primary hover:text-primary/80 font-medium block transition-colors">
              Esqueceu a senha?
            </a>
            <p class="text-sm text-muted-foreground">
              Não tem conta?
              <a routerLink="/register" class="text-primary hover:text-primary/80 font-semibold transition-colors">Criar conta</a>
            </p>
          </div>
        </div>
      </div>
